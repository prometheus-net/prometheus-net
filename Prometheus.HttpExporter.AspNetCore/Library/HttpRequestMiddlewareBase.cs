...
namespace Prometheus.HttpExporter.AspNetCore.Library
{
    ...
    public class HttpRequestMiddlewareBase<T> where T : ICollector
    {
        protected HttpRequestMiddlewareBase(T collector)
        {
            ...
            if (!LabelsAreValid(collector.LabelNames)) throw new ArgumentException(
        ...
        private bool LabelsAreValid(string[] labelNames) => _allowedLabelNames.IsSupersetOf(labelNames);
